...
class Planet:
    ...
    # Les paramètres par défauts correspondent à la Terre, en supposant sont orbite circulaire
    ...
    def acc_cyl(self, t, pos, vel) :
        ...
        B[0] = -2*vel[1]*vel[0]/pos[1]
        B[1] = pos[1]*vel[0]**2-self.k/pos[1]**2
        return B
    
    def Em_cyl(self, A) :
        Em = 1/2*(A[3]**2+A[1]**2*A[2]**2)-self.k/A[1]
        return Em
    ...
    def acc_cart(self, t, pos, vel) :
        ...
        B[0] = (-self.k/r**3)*pos[0]
        B[1] = (-self.k/r**3)*pos[1]
        return B
